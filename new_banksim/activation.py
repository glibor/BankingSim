...
class MultiStepActivation:
    ...
    def __init__(self, model):
        ...
        self.real_sector_clearing_house = None
        self.banks = []
        self.depositors = []
    ...
    def add_real_clearing_house(self, real_sector_clearing_house):
        self.real_sector_clearing_house = real_sector_clearing_house
